...
import { BaseResponse, IdentityService, RegisterModel, Status, isResultSuccess, runOnQueryParam } from '@lcu/common';
import { MatHorizontalStepper, MatList, MatListItem } from '@angular/material';
import { PageUIService } from '../../../svc/page-ui.service';
import { ConfirmPasswordRecoveryModel } from '@lcu/common/lib/identity/confirm-password-recovery-model';
import { RecoverPasswordModel } from '@lcu/common/lib/identity/recover-password-model';
...
export class RecoverPasswordComponent implements OnInit {
    ...
    //  Constructors
    constructor(protected idSvc: IdentityService, protected route: ActivatedRoute, protected formBldr: FormBuilder, protected pgUiSvc: PageUIService) {
    }
    ...
    public ngOnInit() {
        ...
        runOnQueryParam(this.route, "code", (params) => {
