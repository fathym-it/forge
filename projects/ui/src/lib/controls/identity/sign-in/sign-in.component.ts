...
import { BaseResponse, IdentityService, SignInModel, Status, isResultSuccess, runOnQueryParam } from '@lcu/common';
...
export class ForgeSignInComponent implements OnInit {
	...
	public ngOnInit() {
		...
		runOnQueryParam(this.route, 'redirectTo', (params: any) => {
