...
@Component({
	selector: 'app-static-data-streamer',
	templateUrl: './static-data-streamer.html',
})
export class StaticDataStreamerComponent extends BaseModuleManagerComponent implements OnInit {
	//	Fields
